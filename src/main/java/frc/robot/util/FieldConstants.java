...
public class FieldConstants {
  ...
  public static final class Speaker {
    ...
    public static Pose2d centerSpeakerOpening2d = new Pose2d(0.0, fieldWidth - Units.inchesToMeters(104.0),
        new Rotation2d());

    /** Center of the speaker opening (blue alliance) */
    public static final Translation3d centerSpeakerOpening3d = bottomLeftSpeaker.interpolate(topRightSpeaker, 0.5);
  }
  ...
  public static Translation2d cornerFeedLocation = new Translation2d(Units.inchesToMeters(70.5),
      Units.inchesToMeters(275.77));
