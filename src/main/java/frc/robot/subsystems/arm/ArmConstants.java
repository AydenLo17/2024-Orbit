...
public class ArmConstants {
    ...
    public static final Rotation2d minAngle = switch (Constants.getRobot()) {
    ...
    public static final int leaderID = switch (Constants.getRobot()) {
        default -> 11;
        case COMPBOT -> 25;
    };
    public static final int followerID = switch (Constants.getRobot()) {
        default -> 10;
        case COMPBOT -> 26;
    };
    public static final int armEncoderID = switch (Constants.getRobot()) {
        default -> 0;
        case COMPBOT -> 42;
    };
    ...
    public static final double armEncoderOffsetDegrees = switch (Constants.getRobot()) {
        default -> 1.21784482;
        // corresponding to an arm position of 0.1043106935762236 rad
        case COMPBOT -> -1.233 - Math.PI / 2.0;
    };

    public static final double armLength = switch (Constants.getRobot()) {
    ...
    public static TrapezoidProfile.Constraints profileConstraints = new TrapezoidProfile.Constraints(2 * Math.PI, 15);
