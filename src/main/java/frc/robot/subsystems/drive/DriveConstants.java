...
public final class DriveConstants {
  ...
  public static final ModuleConstants moduleConstants = switch (Constants.getRobot()) {
    case COMPBOT ->
      new ModuleConstants(
          ...
          10.0,
          0.0,
          Mk4cReductions.L3PLUS.reduction,
          Mk4cReductions.TURN.reduction);
    case SIMBOT ->
      new ModuleConstants(
          0.014,
          0.134,
  ...
  private enum Mk4cReductions {
    L1PLUS((50.0 / 16.0) * (19.0 / 25.0) * (45.0 / 15.0)),
    L2PLUS((50.0 / 16.0) * (17.0 / 27.0) * (45.0 / 15.0)),
    L3PLUS((50.0 / 16.0) * (16.0 / 28.0) * (45.0 / 15.0)),
    TURN((12.8 / 1.0));

    final double reduction;

    Mk4cReductions(double reduction) {
