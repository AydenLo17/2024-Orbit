...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        inputs.turnPosition = Rotation2d
                .fromRotations(turnPosition.getValueAsDouble() / moduleConstants.turnReduction());
        ...
        inputs.odometryDrivePositionsRad = drivePositionQueue.stream()
                .mapToDouble(
                        (Double value) -> Units.rotationsToRadians(value) / moduleConstants.driveReduction())
                .toArray();
    ...
    public void setTurnBrakeMode(boolean enable) {
        var config = new MotorOutputConfigs();
        config.Inverted = DriveConstants.moduleConfigs[0].turnMotorInverted()
    ...
    public void registerSelfCheckHardware(AdvancedSubsystem subsystem) {
        subsystem.registerHardware("Drive Motor", driveTalon);
        subsystem.registerHardware("Rotation Motor", turnTalon);
        subsystem.registerHardware("Rotation Encoder", cancoder);
    }
}
