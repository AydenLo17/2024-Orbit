...
public class SmartController {
  ...
  private AimingParameters targetAimingParameters =
      new AimingParameters(Rotation2d.fromDegrees(90), 0.0, 40.5, ArmConstants.minAngle, 2, 0);
  ...
  public void calculateSpeaker(
    ...
    Translation2d speakerPose =
        AllianceFlipUtil.apply(FieldConstants.Speaker.centerSpeakerOpening2d.getTranslation());
